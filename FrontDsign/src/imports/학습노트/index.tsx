import svgPaths from "./svg-z5p5mdd2xs";
...
function Frame() {
  return <div className="bg-[rgba(255,255,255,0.2)] h-[8px] relative rounded-[9999px] shrink-0 w-[40px]" />;
}

function Container68() {
  return (
    <div className="content-stretch flex flex-col h-[20px] items-center justify-center overflow-clip px-[8px] relative shrink-0 w-full" data-name="Container">
      <Frame />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start justify-center not-italic relative shrink-0 whitespace-nowrap">
      <div className="flex flex-col font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[11px] text-[rgba(255,255,255,0.2)] text-center" style={{ fontFeatureSettings: '"lnum" 1, "tnum" 1' }}>
        <p>
          <span className="leading-[normal] text-[rgba(255,255,255,0.2)]">학습</span>
          <span className="leading-[normal]">{` 일정`}</span>
        </p>
      </div>
      <p className="font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[20px] text-white" style={{ fontFeatureSettings: '"lnum" 1, "tnum" 1' }}>
        5월 18일
      </p>
    </div>
  );
...
function Frame2() {
  return (
    <div className="bg-[#818cf8] content-stretch flex items-center justify-center p-[8px] relative rounded-[99px] shrink-0">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap" style={{ fontFeatureSettings: '"lnum" 1, "tnum" 1' }}>
        4개 등록
      </p>
    </div>
  );
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
        <g id="Icon">
          <path d={svgPaths.p26740b90} id="Vector" stroke="white" strokeLinecap="round" strokeOpacity="0.4" strokeWidth="1.45833" />
        </g>
      </svg>
    </div>
  );
...
function Button33() {
  return (
    <div className="content-stretch flex h-[32px] items-center justify-center relative rounded-[999px] shrink-0 w-[36px]" data-name="Button">
      <Icon3 />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[2px] items-center opacity-30 relative shrink-0">
      <Frame2 />
      <Button33 />
    </div>
  );
...
function Conteiner() {
  return (
    <div className="content-stretch flex h-[70px] items-center justify-between overflow-clip px-[20px] relative shrink-0 w-full" data-name="Conteiner">
      <Frame1 />
      <Frame3 />
    </div>
  );
...
function Container71() {
  return <div className="bg-[#818cf8] h-[40px] relative rounded-[33554400px] shrink-0 w-[4px]" data-name="Container" />;
}

function Paragraph5() {
  return (
    <div className="content-stretch flex flex-col h-[21px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">수학 — 미적분 기초</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start pt-[2px] relative shrink-0 w-[249px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.4)] whitespace-nowrap">09:00 · 90분</p>
    </div>
  );
}
...
function Container72() {
  return (
    <div className="content-stretch flex flex-[248_0_0] flex-col items-start min-w-px relative" data-name="Container">
      <Paragraph5 />
      <Paragraph6 />
    </div>
  );
...
function Text16() {
  return (
    <div className="bg-[rgba(129,140,248,0.13)] content-stretch flex flex-col items-start px-[10px] py-[4px] relative rounded-[33554400px] shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[#818cf8] text-[11px] whitespace-nowrap">수학</p>
    </div>
  );
}
...
function ScheduleCard() {
  return (
    <div className="bg-[rgba(255,255,255,0.07)] border border-[rgba(255,255,255,0.1)] border-solid content-stretch flex gap-[12px] items-center px-[16px] py-[14px] relative rounded-[16px] shrink-0 w-full" data-name="ScheduleCard">
      <Container71 />
      <Container72 />
      <Text16 />
    </div>
...
function Paragraph7() {
  return (
    <div className="content-stretch flex flex-col h-[21px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">영어 독해 훈련</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start pt-[2px] relative shrink-0 w-[249px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.4)] whitespace-nowrap">11:30 · 60분</p>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="bg-[rgba(129,140,248,0.13)] content-stretch flex flex-col items-start px-[10px] py-[4px] relative rounded-[33554400px] shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[#818cf8] text-[11px] whitespace-nowrap">영어</p>
    </div>
  );
}

function ScheduleCard1() {
  return (
    <div className="bg-[rgba(255,255,255,0.07)] border border-[rgba(255,255,255,0.1)] border-solid content-stretch flex gap-[12px] items-center px-[16px] py-[14px] relative rounded-[16px] shrink-0 w-full" data-name="ScheduleCard">
      <Container73 />
      <Container74 />
...
function Paragraph9() {
  return (
    <div className="content-stretch flex flex-col h-[21px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">물리 — 운동 법칙</p>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start pt-[2px] relative shrink-0 w-[249px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.4)] whitespace-nowrap">14:00 · 120분</p>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="bg-[rgba(129,140,248,0.13)] content-stretch flex flex-col items-start px-[10px] py-[4px] relative rounded-[33554400px] shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[#818cf8] text-[11px] whitespace-nowrap">과학</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="content-stretch flex flex-col h-[21px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">국어 문학 분석</p>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start pt-[2px] relative shrink-0 w-[249px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.4)] whitespace-nowrap">17:00 · 45분</p>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="bg-[rgba(129,140,248,0.13)] content-stretch flex flex-col items-start px-[10px] py-[4px] relative rounded-[33554400px] shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[#818cf8] text-[11px] whitespace-nowrap">국어</p>
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
        <g id="Icon">
          <path d={svgPaths.p3cabda00} id="Vector" stroke="white" strokeLinecap="round" strokeOpacity="0.4" strokeWidth="1.45833" />
        </g>
      </svg>
    </div>
  );
...
function Button34() {
  return (
    <div className="border border-[rgba(255,255,255,0.15)] border-dashed content-stretch flex gap-[8px] items-center justify-center py-[12px] relative rounded-[16px] shrink-0 w-[352px]" data-name="Button">
      <Icon4 />
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.4)] text-center whitespace-nowrap">일정 추가</p>
    </div>
  );
}
...
function ButtonMargin() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col items-start pt-[4px] relative shrink-0" data-name="Button:margin">
      <Button34 />
    </a>
  );
}
...
function Container70() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start min-h-px overflow-clip pb-[16px] px-[24px] relative w-full" data-name="Container">
      <ScheduleCard />
      <ScheduleCard1 />
      <ScheduleCard2 />
      <ScheduleCard3 />
...
function Container67() {
  return (
    <div className="backdrop-blur-[40px] border-[rgba(255,255,255,0.12)] border-l border-r border-solid border-t content-stretch flex flex-col gap-[8px] h-[540px] items-start overflow-clip relative rounded-tl-[28px] rounded-tr-[28px] shadow-[0px_-20px_60px_0px_rgba(0,0,0,0.5)] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(159.9326316979665deg, rgba(49, 46, 129, 0.97) 45.699%, rgba(30, 27, 75, 0.99) 94.556%)" }} data-name="Container">
      <Container68 />
      <Conteiner />
      <ContainerMargin1 />
      <Container70 />
