...
export function BottomSheet({ eyebrow, title, onClose, headerExtra, children }: BottomSheetProps) {
  return (
    <div
      className="flex w-full flex-1 flex-col items-start rounded-tl-sheet rounded-tr-sheet border-t border-surface-border shadow-[0px_-20px_60px_0px_rgba(0,0,0,0.5)]"
      style={{
